...
class Z1RealRobotRoughCfg( LeggedRobotCfg ):
    ...
    class asset( LeggedRobotCfg.asset ):
        file = '/home/zhipy/project/unitree_rl_gym/resources/robots/b2z1/b2z1_fixedb2.urdf'
        name = "z1"
...
class Z1RealRobotRoughCfgPPO( LeggedRobotCfgPPO ):
    class algorithm( LeggedRobotCfgPPO.algorithm ):
        entropy_coef = 0.01
    class runner( LeggedRobotCfgPPO.runner ):
        run_name = ''
        experiment_name = 'z1_realrobot'
