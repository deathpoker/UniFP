...
from legged_gym.envs.base.legged_robot_b2z1_realrobot import LeggedRobot_b2z1_realrobot
from legged_gym.utils.math import wrap_to_pi
from legged_gym.utils.helpers import class_to_dict
from legged_gym.utils.terrain_b2 import Terrain, Terrain_Perlin

from legged_gym.envs.b2.b2z1_force_realrobot_config import B2Z1ForceRealRobotRoughCfg
...
class LeggedRobot_b2z1_force_realrobot(BaseTask):
    def __init__(self, cfg: B2Z1ForceRealRobotRoughCfg, sim_params, physics_engine, sim_device, headless):
    ...
    def compute_observations(self):
        ...
        obs_buf = torch.cat((       self.projected_gravity,  # dim 3
                                    ...
                                    sin_pos, # 1
                                    cos_pos, # 1
                                    self.commands * self.commands_scale, # dim 12
    ...
    def _get_noise_scale_vec(self, cfg):
        ...
        noise_vec[6+self.num_actions:6+self.num_actions*2] = noise_scales.dof_vel * noise_level * self.obs_scales.dof_vel
        noise_vec[6+self.num_actions*2:6+self.num_actions*3] = 0. # previous actions
