...
class LeggedRobotB2Z1(BaseTask):
    ...
    def compute_observations(self):
        ...
        self.obs_buf = torch.cat((  self.base_lin_vel * self.obs_scales.lin_vel,
                                    ...
                                    (self.dof_pos - self.default_dof_pos)[:, :12] * self.obs_scales.dof_pos,
    ...
    def _compute_torques(self, actions):
        ...
        if control_type=="P":
            ...
            torques = self.p_gains * (actions_scaled + self.default_dof_pos_wo_arm - self.dof_pos_wo_arm) - self.d_gains * self.dof_vel_wo_arm
        elif control_type=="V":
    ...
    def _init_buffers(self):
        ...
        self.dof_pos_wo_arm = self.dof_pos[:, :12]
        self.dof_vel = self.dof_state.view(self.num_envs, self.num_dof, 2)[..., 1]
        self.dof_vel_wo_arm = self.dof_vel[:, :12]
        self.base_quat = self.root_states[:, 3:7]
        self.rpy = get_euler_xyz_in_tensor(self.base_quat)
        ...
        self.gripper_torques_zero = torch.zeros(self.num_envs, 7, device=self.device)
        ...
        self.default_dof_pos_wo_arm = self.default_dof_pos[:12]
