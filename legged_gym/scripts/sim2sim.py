...
from legged_gym.envs import G1HumanoidGymWithArmCfg
import torch
...
def run_mujoco(policy, cfg):
    ...
    for _ in tqdm(range(int(cfg.sim_config.sim_duration / cfg.sim_config.dt)), desc="Simulating..."):
        ...
        if count_lowlevel % cfg.sim_config.decimation == 0:
            ...
            obs[0, 5:34] = q * cfg.normalization.obs_scales.dof_pos
            obs[0, 34:63] = dq * cfg.normalization.obs_scales.dof_vel
            obs[0, 63:92] = action
            obs[0, 92:95] = omega
            obs[0, 95:98] = eu_ang
